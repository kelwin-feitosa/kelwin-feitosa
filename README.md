...
Sistema de análise de crédito desenvolvido para consolidar conceitos de lógica de negócio e integridade de dados.
- **Diferenciais:** Uso de `BigDecimal` para precisão em cálculos financeiros e implementação de exceções personalizadas.
